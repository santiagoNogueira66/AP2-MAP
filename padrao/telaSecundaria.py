...
class GastosView:
    def __init__(self, root):
        ...
        self.gastar["command"] = lambda: self.inserir_gastos()
    ...
    def inserir_gastos(self):
        gastos = self.obter_gastos()
        GastosController.inserir_gastos(gastos)
        self.exibir_dados_do_banco()
        self.limpar_entrys()
...
class GastosController:
    ...
    @staticmethod
    def inserir_gastos(gastos):
        GastosModel.inserir_gastos(gastos)

    @staticmethod
    def editar_gastos(gastos):
